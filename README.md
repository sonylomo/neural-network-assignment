...
The tasks are compute-heavy and we recommend to run them on your hardware for optimal performance.
...
Now you can open a notebook for the corresponding week and work there 
